...
class SheetSelectionAdapter(private val items: List<Item>,
	...
	override fun onBindViewHolder(holder: ViewHolder, position: Int) {
		holder.onBindView(items[position], position, position == selectedPosition, onItemSelectedListener)
	}

	class ViewHolder(override val containerView: View) : RecyclerView.ViewHolder(containerView),
			LayoutContainer {

		fun onBindView(item: Item, position: Int, selected: Boolean,
